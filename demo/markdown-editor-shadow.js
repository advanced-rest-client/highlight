...
window.customElements.define('shadow-prism-highlight', class extends LitElement {
  ...
  render() {
    const { markdown } = this;
    return html`
    <markdown-editor .markdown="${markdown}" toolbar contextToolbarEnabled .document="${this.shadowRoot}">
      <div slot="markdown-html" id="content"></div>
      <slot name="post-toolbar" slot="post-toolbar"></slot>
    </markdown-editor>
    `;
  }
});
...
class ComponentPage extends DemoPage {
  constructor() {
    ...
    this.componentName = 'markdown-editor (shadow root)';
...
`;
  ...
  _demoTemplate() {
    ...
    <section class="documentation-section">
      ...
      >
        <shadow-prism-highlight .markdown="${markdown}" slot="content">
